						...
						<div class="col-md-8">
							...
							<?php
								...
								if(!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true):?>
									<p class="lead white-text" style="margin-left: 5px; color: #13534f; font-weight: 700; font-size: 25px;" ><b>We provide piracy protection to protect a software from being unlawfully duplicated online.</b></p>
